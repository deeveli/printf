				 ...
				 int flags, int width, int precision, int size)
{
	...
	fmt_t fmt_types[] = {
		{'c', print_char}, {'s', print_string}, {'%', print_percent}, {'z', print_int}, {'d', print_int}, {'b', print_binary}, {'u', print_unsigned}, {'o', print_octal}, {'x', print_hexadecimal}, {'X', print_hexa_upper}, {'p', print_pointer}, {'S', print_non_printable}, {'r', print_reverse}, {'R', print_rot13string}, {'\0', NULL}};
